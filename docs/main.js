...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {S: fragment, U: host, Z: path, aa: port_, ae: protocol, af: query};
	});
...
var $author$project$Main$defaultScheme = {
	G: 'Rose',
	y: {r: 'main', X: _List_Nil, ab: _List_Nil}
};
var $author$project$Main$emptyModel = {r: $author$project$Main$defaultScheme, X: _List_Nil, ab: _List_Nil};
...
var $author$project$Ring$backward = function (ring) {
	...
	if (_v0.a.b) {
		...
		return {
			r: p,
			X: A2($elm$core$List$cons, curr, xs),
			ab: ps
		};
	} else {
		var xs = _v0.b;
		...
		if (reversedNext.b) {
			...
			return {r: newCurr, X: _List_Nil, ab: rest};
		} else {
			return ring;
		}
	}
...
var $author$project$Ring$forward = function (ring) {
	...
	if (_v0.b.b) {
		...
		return {
			r: x,
			X: xs,
			ab: A2($elm$core$List$cons, curr, ps)
		};
	} else {
		var ps = _v0.a;
		...
		if (reversedPrev.b) {
			...
			return {r: newCurr, X: rest, ab: _List_Nil};
		} else {
			return ring;
		}
	}
...
var $author$project$Main$className = function (_v0) {
	var name = _v0.G;
	var variants = _v0.y;
	var variantName = variants.r;
	var hyphenatedName = A3(
		$elm$core$String$replace,
		' ',
		'-',
		$elm$core$String$toLower(name));
	return hyphenatedName + ('-' + variantName);
};
...
var $author$project$Main$colorBlock = function (colorName) {
	return A2(
		$elm$html$Html$li,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('color-block ' + colorName)
					]),
				_List_Nil)
			]));
};
var $author$project$Main$colorNames = _List_fromArray(
	['red', 'green', 'yellow', 'blue', 'magenta', 'cyan']);
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Main$viewColorDots = A2(
	$elm$html$Html$ul,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('blocks')
		]),
	A2($elm$core$List$map, $author$project$Main$colorBlock, $author$project$Main$colorNames));
var $author$project$Main$view = function (_v0) {
	var curr = _v0.r;
	var currVariant = curr.y.r;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				$author$project$Main$className(curr))
			]),
		_List_fromArray(
			[
				A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$id('scheme-name')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(curr.G)
							]))
					])),
				$author$project$Main$viewColorDots,
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('scheme-variant')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(currVariant)
							]))
					]))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{ay: $author$project$Main$init, aD: $author$project$Main$subscriptions, aF: $author$project$Main$update, aG: $author$project$Main$view});
